...
import webbrowser
import pyfiglet
#satanlarin aminakoyam

#editleyio benim diyenin aw
#editleyio benim diyenin aw
try:
...
ascii_art = pyfiglet.figlet_format("TONY STARK \nTarih", font="small")
...
#editleyenin aw koyam
def amir():
    os.system('clear')
    output = (f"\n"
f"{white} • [ Hit: {green}{hits}{white}] | Bad IG: {red}{badinsta}{white}| Bad Email:{yellow}{bademail} {white}| Good IG: {orange}{goodig} {cyan} \n@evrenisikti"
...
{green}• 1 -İNSTAGRAM 2012 - 2013
                            
{green}• 2 -İNSTAGRAM 2014 - 2015

{green}• 3 -İNSTAGRAM 2013 - 2020
                                                
""")
zyphor = input(f"{white} SEÇ : {reset}")
...
➟ 𝐌𝐚ı𝐥 : {username}@{gg}
➟ 𝐑𝐞𝐬𝐭: {rest(username)}
➟ 𝐋ı𝐧𝐤: https://www.instagram.com/{username}
<<════════𝐓𝐎𝐍𝐘════════>>
